...
function counter() {
  ...
  retornando un valor numérico que empieza en 1 e 
...
// var resultadoUno = funcion (2);
  ...
  Esta función debe aceptar un argumento (arg) 
  e invocar a cb con ese argumento; hecho eso, 
...
/*
  ...
  tres funciones que retornen una cadena (string) y el delimitador especificado (asteriscos, guiones, 
    y guiones bajos, respectivamente). Las funciones obtenidas deberían recibir solamente un argumento 
...
let textoAsteriscos = crearCadena.bind(this,'*', '*'); //vale aclarar que puede ser cualquier dato si this no apunta a nada.
